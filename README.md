...
|---|---|
|목표|설명|
|🛠 서버 가용성 및 부하 기록|서버 현황을 처리하고 관리|
|👤 사용자 로그인 기록 분석|사용자의 로그인 계정 및 보조|
|⚠ 시스템 오류 및 서비스 장애 감지|오류 확인 및 알림|
|📂 디스크 사용량 모니터링|디스크 업데이트 및 필수 작업|
|🛡️ 네트워크 연결 상태 모니터링|해당 상태 처리|
|💡 CPU 사용량 및 프로세스 자동 정리|CPU 과부하 프로세스 제거|
